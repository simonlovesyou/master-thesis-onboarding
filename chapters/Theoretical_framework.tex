...
\begin{description}
  ...
  \item[Money] If the target behavior requires money or resources, the disposable amount of resources the person have determines how simple the behavior is. This is ususally not a problem for people with a lot of wealth.
...
% Similiar to http://repository.cmu.edu/cgi/viewcontent.cgi?article=1045&context=hcii
